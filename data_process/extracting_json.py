...
if __name__ == "__main__":
    ...
    parser.add_argument('--input', default=r"Train_text\SkyPile2023-14_zh_head_0000.jsonl", help='输入的JSONL文件路径')
    parser.add_argument('--output', default=r"Train_text\SkyPile2023-14_zh_head_0000_processed.jsonl", help='输出文本文件路径')
    parser.add_argument('--field', default='text', help='要提取的字段名称（默认：content）')
